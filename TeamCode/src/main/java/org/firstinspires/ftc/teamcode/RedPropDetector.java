...
public class RedPropDetector extends OpenCvPipeline {
    ...
    // public final double zoneRange_mid_left = 0.27;
    // public final double zoneRange_mid_right = 0.5;
    ...
    public Mat processFrame(Mat input) {
        ...
        // int line_mid_1 = (int)(input.width() * zoneRange_mid_left);
        // int line_mid_2 = (int)(input.width() * zoneRange_mid_right);
